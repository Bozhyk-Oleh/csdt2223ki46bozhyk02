...
namespace Sea_Battle
{
    public class GridTile : PictureBox
    {
        ...
        protected override void OnPaint(PaintEventArgs e)
        {
            ...
            if (GridPosition.IsHit && !_isOnFire)
                Drawing.DrawHit(this, e.Graphics);
            if (_isOnFire)
                Drawing.DrawFire(this, e.Graphics);
            if (GridPosition.IsMissed)
                Drawing.DrawMiss(this, e.Graphics);
            if (GridPosition.IsSelected) 
                Drawing.DrawSelected(this, e.Graphics);
        }
    }
}
